        ...
        <div className=" flex flex-1 flex-col">
          ...
          <div className=" flex flex-col md:flex-row gap-4 ">
            ...
            {imagesUploading ? (
              <button
                disabled={true}
                className={
                  "transition-all w-24 p-2 rounded-md bg-primaryDark bg-opacity-75 text-primaryBright"
                }
              > ...
                <img
          ...
          {loading || imagesUploading ? (
            <button
              disabled={true}
              className={
                "transition-all w-full p-3 rounded-md bg-primaryDark bg-opacity-75 text-primaryBright"
              }
            >
                Loading...
              <img
