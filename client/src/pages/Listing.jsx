      ...
      {listing && !loading && !error && (
        <div className=" max-w-[1600px] relative mx-auto">
          <Swiper className=" relative" ref={sliderRef}>
            ...
            <div className="prev-arrow p-2 bg-primaryBright z-20 text-primaryColor rounded-full cursor-pointer absolute left-10 top-1/2  -translate-y-1/2" onClick={handlePrev}><FaAngleLeft size={30} /></div>
            <div className="next-arrow p-2 bg-primaryBright z-20 text-primaryColor rounded-full cursor-pointer absolute right-10 top-1/2  -translate-y-1/2" onClick={handleNext}><FaAngleRight size={30} /></div>
          </Swiper>
